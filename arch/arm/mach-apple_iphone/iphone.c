...
static struct platform_device iphone_charger = {
...
static void __init iphone_init(void)
{
	...
	platform_device_register(&iphone_charger);
}
...
static void __exit iphone_exit(void)
{
	...
	platform_device_unregister(&iphone_charger);
}
module_exit(iphone_exit);

MACHINE_START(APPLE_IPHONE, "Apple iPhone 3G")
